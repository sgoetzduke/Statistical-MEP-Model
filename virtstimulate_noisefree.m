function response = virtstimulate_noisefree(amplitude_SI, subject_parameters)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   virtstimulate_noisefree(amplitude_SI, subject_parameters)
...
%
%   result contains neither x nor additive or mult. y noise!
%
